...
<body>
	...
	List<BookDtls> oldAvailableBooks = dao.getBooksByCategoryAndStatus("Old", "Available");
	List<BookDtls> oldOutOfStockBooks = dao.getBooksByCategoryAndStatus("Old", "Out of Stock");
	%>
...
<div class="container">
    <div class="row">
        ...
        for (BookDtls book : oldAvailableBooks) {
        %>
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="btn-container mt-2">
                        <a href="#" class="btn btn-danger btn-sm btn-icon" aria-disabled="true"> 
        ...
        for (BookDtls book : oldOutOfStockBooks) {
        %>
        <div class="col-md-3 book-card">
            <div class="card">
                <div class="card-body text-center">
